...
![PEK2025完成サイトのトップページスクリーンショット](./images/PEK2025完成サイトのトップページスクリーンショット.png)
...
PEK2025のロゴおよびデザインガイド（フォントとカラーパレット）がすでに決定していたため、それらを活用してv0にティザーページを作成してもらいました。
...
![TODO: v0への入力プロンプト画面スクリーンショット](./images/v0への入力プロンプト画面スクリーンショット1.png)

![TODO: v0への入力プロンプト画面スクリーンショット](./images/v0への入力プロンプト画面スクリーンショット2.png)
...
![v0で生成されたティザーページのプレビュー画像](./images/v0で生成されたティザーページのプレビュー画像.png)
...
![Clineの作業プロセス画面スクリーンショット](./images/Clineの作業プロセス画面スクリーンショット.png)
...
![ウェブサイトのスクショ](./images/ウェブサイトのスクショ.png)
...
![TODO: v0のfork機能使用画面スクリーンショット](./images/v0のfork機能使用画面スクリーンショット.png)
...
プロポーザルの一覧ページ
![各ページのデザイン統一性を示す比較画像-プロポーザル一覧](./images/各ページのデザイン統一性を示す比較画像-プロポーザル一覧.png)

プロポーザルの詳細ページ
![各ページのデザイン統一性を示す比較画像-プロポーザル一覧](./images/各ページのデザイン統一性を示す比較画像-プロポーザル詳細.png)
...
![](./images/v0+clineを活用したワークフロー.png)
